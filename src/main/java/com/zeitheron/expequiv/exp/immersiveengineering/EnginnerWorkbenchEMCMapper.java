...
class EnginnerWorkbenchEMCMapper implements IEMCMapper<NormalizedSimpleStack, Integer>
{
	...
	{
		block2: for(BlueprintCraftingRecipe recipe : BlueprintCraftingRecipe.recipeList.values())
		{
	...
	public Iterable<CraftingIngredients> getIngredientsFor(BlueprintCraftingRecipe recipe)
	{
