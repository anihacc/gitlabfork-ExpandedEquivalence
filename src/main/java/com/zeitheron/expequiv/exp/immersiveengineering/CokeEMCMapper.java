...
class CokeEMCMapper implements IEMCMapper<NormalizedSimpleStack, Integer>
{
	@Override
	public void addMappings(IMappingCollector<NormalizedSimpleStack, Integer> mapper, Configuration cfg)
	{
		block2: for(CokeOvenRecipe recipe : CokeOvenRecipe.recipeList)
		{
	...
	{
		return "IECokeOvenMapper";
	}
	
	@Override
	public String getDescription()
	{
		return "Add Conversions for coke oven recipes";
	}
	...
	public Iterable<CraftingIngredients> getIngredientsFor(CokeOvenRecipe recipe)
	{
